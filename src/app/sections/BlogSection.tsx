  ...
  return (
    <section id="blog" className="w-full py-20 flex flex-col items-center bg-transparent">
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-3 gap-8">
        {posts.map((post, idx) => (
          <div key={post.slug} className="glass card-hover p-6 flex flex-col animate-fade-in">
            <div className="mb-4 rounded-xl overflow-hidden">
              <Image
                src={post.image}
                alt={`Desert landscape for ${post.title}`}
                width={800}
                height={400}
            ...
            <h3 className="text-xl font-bold mb-2 text-blue-700 dark:text-pink-400">{post.title}</h3>
            ...
            <div className="mb-4">
              ...
              }}>{post.content.slice(0, 200) + (post.content.length > 200 ? "..." : "")}</ReactMarkdown>
            </div>
